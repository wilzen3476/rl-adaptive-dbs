...
| **Fig. 4a (training $P_\beta$ vs step)** | 45 Hz DDPG; noisy early, drop ~step 130–150 | `scripts/figures/papers/mehregan/4a/plot.py`; seed 0, softmax+one_hot, L=1; qualitative shape (v4) | 2026-07-13; [figures/mehregan/replications.md](../figures/mehregan/replications.md) |
| **Fig. 4b (reward + PSD vs episode)** | Episodes 0–8: reward↑, episode-mean PSD↓ | `scripts/figures/papers/mehregan/4b/plot.py`; paired Fig 4a v4, **seed 0** (paper seed unspecified); two PNGs; qualitative trend | 2026-07-13; [figures/mehregan/replications.md](../figures/mehregan/replications.md) |
