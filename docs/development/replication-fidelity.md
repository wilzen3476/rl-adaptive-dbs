...
| **Fig. 2b (Error Index time series)** | So-style SMC→TH drive; blue below red after $t=2$ | `scripts/figures/papers/1/2b/plot.py`; path A hybrid; seed 0 | 2026-07-13; [plant.md](../plant.md) §8.3; [paper_1.md](../figures/paper_1.md) |
| **Fig. 4a (training $P_\beta$ vs step)** | 45 Hz DDPG; noisy early, drop ~step 130–150 | `scripts/figures/papers/1/4a/plot.py`; seed 0, softmax+one_hot, L=1; qualitative shape (v4) | 2026-07-13; [paper_1.md](../figures/paper_1.md) |
| **Fig. 4b (reward + PSD vs episode)** | Episodes 0–8: reward↑, episode-mean PSD↓ | `scripts/figures/papers/1/4b/plot.py`; paired Fig 4a v4, **seed 0** (paper seed unspecified); two PNGs; qualitative trend | 2026-07-13; [paper_1.md](../figures/paper_1.md) |
