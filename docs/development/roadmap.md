...
**How this relates to phases:** Phases 1–3 (specs, environment, DDPG) and most Phase 4 **infrastructure** (benchmark runner, `rl-dbs`, `rl-dbs-tui`, PTQ/QAT hooks) are **done**. **Setup scripts:** Python-only path **re-verified on maintainer WSL** (2026-07-18); Multipass / Sandbox and `--with-matlab` still pending — [setup.md](../setup.md) § Setup script verification status. Mehregan panel set is **Pass** (Figs 1b–6b) — polish/digitization notes in [replication-fidelity.md](replication-fidelity.md). **Phase 5 (Nguyen / SNN)** and **Phase 6 (SEA-DBS)** are active in parallel — trackers [figures/nguyen/replications.md](../../figures/nguyen/replications.md) and [figures/ravivarapu/replications.md](../../figures/ravivarapu/replications.md). Phases 7–9 (cross-controller comparison, fusion, native plant) stay deferred until needed.

**Parallel tracks:**

| Track | Tracker | Focus now |
|-------|---------|-----------|
| Mehregan (paper 1) | [figures/mehregan/replications.md](../../figures/mehregan/replications.md) | Figs 1b–6b Pass |
| Nguyen (paper 2) | [figures/nguyen/replications.md](../../figures/nguyen/replications.md) | Fig 3 Pass; Fig 4–7 open |
...
- **Figure track:** [figures/nguyen/replications.md](../../figures/nguyen/replications.md) (Fig 3 Pass; Fig 4–7 open).
- **Exit criteria:** `snn` trains/evals on the **same plant** through its documented adapter; `nguyen_eval` runs complete; qualitative panel gates in the Nguyen tracker.

### Phase 6 — SEA-DBS controller (`sea_dbs`), adapter, and per-paper benchmarking (**active**)
...
| `controllers/sea_dbs/` | In progress | Phase 6 active — Fig 4a/4b Pass; Figs 5–7 open — [figures/ravivarapu/replications.md](../../figures/ravivarapu/replications.md) |
...
| Figure panel scripts (`scripts/figures/papers/`) | Partial | Mehregan: 1b–6b Pass — [figures/mehregan/replications.md](../../figures/mehregan/replications.md); Nguyen: Fig 3 Pass, 4–7 open — [figures/nguyen/replications.md](../../figures/nguyen/replications.md); Ravivarapu: 4a/4b Pass — [figures/ravivarapu/replications.md](../../figures/ravivarapu/replications.md) |

**Scheduling axis:** parallel figure tracks — Nguyen ([figures/nguyen/replications.md](../../figures/nguyen/replications.md): Fig 4–7) and Ravivarapu ([figures/ravivarapu/replications.md](../../figures/ravivarapu/replications.md): Figs 5–7); Mehregan panel set Pass.

**Phase map (reference):** Phases 1–4 infrastructure largely **complete**; Phase 5 (Nguyen) and Phase 6 (SEA-DBS) **active in parallel**; Phases 7+ deferred. **Setup scripts:** WSL python-only verified 2026-07-18; fresh VMs and MATLAB path outstanding ([setup.md](../setup.md) § Setup script verification status, [fresh-validation.md](fresh-validation.md)).
...
| Doc | Role |
|-----|------|
| [figures/mehregan/replications.md](../../figures/mehregan/replications.md) | Mehregan panel replication tracker |
| [figures/nguyen/replications.md](../../figures/nguyen/replications.md) | Nguyen DSQN panel replication tracker |
| [figures/ravivarapu/replications.md](../../figures/ravivarapu/replications.md) | Ravivarapu SEA-DBS panel replication tracker |
