...
**Parked:** Kumaravelu 50 Hz does not accumulate the paper’s late 0.332→0.310 slope. Independent shots are the only smooth traces; once $n_{\mathrm{obs}}$ fills they are a horizontal floor. Do not plot last-window instead of the Eq. 4–5 mean, do not raise `n_obs` to fake a late slope with leftover untreated, and do not add AR(1) / EMA at plot time. Keep v15.
