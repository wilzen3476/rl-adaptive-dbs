...
**Gumbel eval seed:** plant reset stays seed 0. `torch.manual_seed(0)` draws 10/10 stim on Baseline at untreated $P_\beta$ (~6% of sequences) — 5a v7 / 5b v5 were identical always-on. Offset **+1** (`GUMBEL_EVAL_SEED_OFFSET`) is a typical 8/10 Baseline / 10/10 SEA draw.
