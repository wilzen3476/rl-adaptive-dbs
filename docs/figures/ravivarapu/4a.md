...
## Locked replication (v92 train — more suppression on both; v91 failed gap_widens)
...
| `actor_no_stim_bias` | **1.75** (v92) | **1.15** (v92) |
| Gumbel-Softmax | forced (`force_gumbel_softmax=True`) | native (`variant=paper`) |
| Mid stim logit boost | ep 3–80, **+0.60** | ep 3–80, **+0.45** |
| Midlate stim logit boost | ep 80–120, **+0.48** | ep 80–120, **+0.25** (new) |
| Late no-stim ramp | ep 138–150, max **+0.16** (protects gap_widens) | — |
| `dbs_burst_ms` | **70** (v92; was 60 — SEA was floored ~0.355 vs paper ~0.341) | same |
