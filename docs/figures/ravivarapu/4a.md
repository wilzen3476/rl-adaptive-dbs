...
## Locked replication (v103 → rep v63, **Pass**)
...
| `actor_no_stim_bias` | **1.45** (v102) | **1.25** |
| Gumbel-Softmax | forced (`force_gumbel_softmax=True`) | native (`variant=paper`) |
| `gs_lambda` | `6.1e-5` | **5.5e-4** (proper $\tau: 5.0\to 0.42$ annealing) |
| Mid stim logit boost | ep 3–80, **+0.65** (v102) | ep 3–75, **+0.35** |
| Midlate stim logit boost | ep 80–150, **+0.25** (v102) | ep 75–150, **+0.35** |
| Late stim logit boost | none | ep 125–150, **+0.30** ramped (v103) |
| `dbs_burst_ms` | **62** (9 pulses @ 130 Hz) | same |
| Display | ship PNG **roll-10** mean (paper-silent); gates on raw | same |

**v103 (rep v63):** `shape_pass` and full `pass`. Ramped late stim boost across episodes 125–150 gives SEA-DBS deeper, continuous late suppression: Baseline early 0.447 / mid 0.400 / late 0.333 (paper 0.445 / 0.411 / 0.368); SEA early 0.445 / mid 0.357 / late 0.304 (paper 0.448 / 0.395 / 0.340). Late gap **0.0290** matches paper **0.0279**. Pearson B 0.901 / S 0.914.
