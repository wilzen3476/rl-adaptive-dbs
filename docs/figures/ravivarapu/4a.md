...
**Status:** v90 baseline-level + display-roll train in flight. Prior **Pass** at rep v58 (raw). Goal: lower mid/late baseline toward paper dig while keeping dig gates; PNG uses roll-10.
