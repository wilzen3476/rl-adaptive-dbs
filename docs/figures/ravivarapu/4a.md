...
## Locked replication (v93 → rep v62, **Pass**)
...
**v93 (rep v62):** `shape_pass` and full `pass`. Late baseline 0.367 vs paper 0.368; SEA 0.304 vs paper 0.340 (still a bit more suppressed than the digitized SEA, within gate tols). Pearson B 0.89 / S 0.92. Remaining visual gap: SEA late ~−0.036 vs paper; late gap 0.063 vs paper 0.028 (one-sided gates allow a larger gap).
