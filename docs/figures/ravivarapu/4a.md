...
## Locked replication (v91 train — earlier/steeper early–mid dip; prior ship v90→v59)
...
| `actor_no_stim_bias` | **1.90** (v91; was 2.19 / v90) | **1.30** (v91; was 1.55) |
...
| Mid stim logit boost | ep **3–80**, **+0.55** (v91) | ep **3–50**, **+0.40** (v91, new) |
| Midlate stim logit boost | ep 80–120, **+0.40** (v91) | — |
| Late no-stim ramp | ep 138–150, max **+0.08** (v91) | — |
| `polyak_tau` | 0.0035 | 0.0035 (base) |
| `dbs_burst_ms` | 60 | 60 |
| `min_buffer_size` | 192 | 192 |
| Display | ship PNG **roll-10** mean (paper-silent); gates on raw | same |

**v91 goal (from dig):** raise early drop fraction by ep 50 toward paper ~0.40 (v90 ~0.25); lower baseline late toward paper ~0.37 (v90 ~0.416, Δ≈+0.046). Dig gates not loosened.

**Prior ship (v90 → v59):** gates Pass; roll-10 on; absolute baseline level barely moved.
