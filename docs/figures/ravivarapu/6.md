...
| `plant_integration_mode` | `continuous` | One stitched Kumaravelu trajectory per episode; Pβ sampled at each step boundary (`controllers/sea_dbs/plant_integration.py`). Training / Fig 5 default `disconnected`. |
