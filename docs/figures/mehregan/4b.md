...
**Phase 6:** lift episode 4 reward (v37 **−52** vs paper ~**−16**) with `--critic-warmup-steps 50` so the actor starts learning in episode 1–2. Do not retune Eq. (8) or offset the plot. Late-floor gates stay parked unless this run also moves them.
