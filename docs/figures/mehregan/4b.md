...
**Phase 6 result (v33, paired 4a v31):** `--critic-warmup-steps 50` lifted ep4 reward **−42.8** (v37 **−52**; paper ~**−16** still parked). **All gates pass:** late PSD 0.358 (`late_beta_above_threshold`, `late_beta_near_paper`), late reward −4.3 (`late_reward_near_zero`), ep0 0.459. Tracker **Pass**; 4a paired run fails only `mid_fade_vs_paper` (see [4a.md](4a.md)).
