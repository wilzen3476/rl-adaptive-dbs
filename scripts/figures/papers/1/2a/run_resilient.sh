...
#
#   bash scripts/figures/papers/1/2a/run_resilient.sh start
#   bash scripts/figures/papers/1/2a/run_resilient.sh status
#   bash scripts/figures/papers/1/2a/run_resilient.sh stop
#
# Logs land under artifacts/figures/papers/1/2a/run.log (TUI Logs tab scans
...
ARTIFACT_DIR="artifacts/figures/papers/1/2a"
...
CPUS="${FIG2A_CPUS:-0-2}"
WORKER="$REPO_ROOT/scripts/figures/papers/1/2a/run_worker.sh"
...
cmd_start() {
    ...
    echo "check: bash scripts/figures/papers/1/2a/run_resilient.sh status"
}
