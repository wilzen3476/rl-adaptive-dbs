...
Run:
  ...
  uv run python scripts/figures/papers/1/2a/plot.py --no-update-docs  # skip docs/figures/paper_1.md refresh
"""
...
FIGURES_DIR = Path("figures/papers/1/2a")
CACHE_DIR = Path("artifacts/figures/papers/1/2a")
...
def main() -> int:
    ...
    parser.add_argument(
        "--no-update-docs",
        action="store_true",
        help="Skip docs/figures/paper_1.md caption refresh",
    )
