...
Each run writes ``figures/papers/1/2b/error_index_vN.png`` (N auto-increments)
...
FIGURES_DIR = Path("figures/papers/1/2b")
CACHE_DIR = Path("artifacts/figures/papers/1/2b")
