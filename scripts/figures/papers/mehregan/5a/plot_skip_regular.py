#!/usr/bin/env python3
"""Deprecated — use ``scripts/figures/papers/mehregan/5a/plot.py`` (skip_regular is default).
...
Run:
  ...
  python3 scripts/figures/papers/mehregan/5a/plot_skip_regular.py
"""
...
CHECKPOINT = Path("artifacts/figures/papers/mehregan/4a/checkpoint_skip_regular_02s.pt")
OUT_DIR = Path("figures/mehregan/images/5a")
