...
NGUYEN_FIG4_GATE_TIER: dict[str, dict[str, str]] = {
    ...
    "length": {
        ...
        "length_late_plateau": "full",
        "late_length_no_regression": "full",
        "late_timeout_fraction": "full",
        "late_timeout_fraction_300_500": "full",
...
NGUYEN_GATE_GROUPS: dict[str, dict[str, list[tuple[str, str]]]] = {
    "4": {
        "reward": [
            ...
            ("reward_post100_plateau", "smoothed reward ptp ep 100–250 ≤ cap"),
            ("reward_late_plateau", "smoothed reward ptp ep 300–500 near digitized paper"),
        ...
        "length": [
            ...
            ("length_post100_plateau", "smoothed length ptp ep 100–200 ≤ 4.5"),
            ("length_late_plateau", "smoothed length ptp ep 300–500 near digitized paper"),
            ("late_length_no_regression", "smoothed length slope ep 350–490 ≤ 0.02/ep"),
            ("late_timeout_fraction", "raw timeout rate ep 350–500 ≤ 25%"),
            ("late_timeout_fraction_300_500", "raw timeout rate ep 300–500 ≤ 2%"),
...
NGUYEN_GATE_ROWS: dict[str, list[tuple[str, str]]] = {
    ...
    "5": [
        ...
        ("paper_spike_early_near_paper", "digitization — spike early ep 0–50"),
        ...
        ("paper_energy_mid_ramp_near_paper", "digitization — energy mid ramp ep 55–75"),
