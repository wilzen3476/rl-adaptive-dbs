...
NGUYEN_GATE_ROWS: dict[str, list[tuple[str, str]]] = {
    ...
    "6": [
        ...
        ("paper_alpha_beta_series_has_variance", "digitization — α–β series has variance"),
        ("paper_alpha_beta_early_above_theta", "digitization — early α–β > θ=150 (ep 0–50)"),
        ("paper_alpha_beta_early_near_paper", "digitization — early α–β near paper (ep 0–50)"),
        ("paper_alpha_beta_mid_near_paper", "digitization — mid α–β near paper (ep 50–100)"),
        ("paper_alpha_beta_drops_by_100", "digitization — α–β drops by ep 100"),
        ("paper_alpha_beta_post100_below_theta", "digitization — post-100 α–β ≤ θ=150 (ep 100–250)"),
        ("paper_alpha_beta_post100_near_paper", "digitization — post-100 α–β near paper (ep 100–250)"),
        ("paper_alpha_beta_late_below_theta", "digitization — late α–β ≤ θ=150 (ep 350–500)"),
        ("paper_alpha_beta_late_near_paper", "digitization — late α–β near paper (ep 350–500)"),
        ("paper_alpha_beta_mean_near_paper", "digitization — overall α–β mean near paper"),
        ("paper_alpha_beta_monotonic_drop", "digitization — monotonic drop early > mid > late"),
        ("paper_alpha_beta_trend_near_paper", "digitization — late vs early α–β ratio"),
    ...
    "7": [
        ...
        ("paper_eval_protocol_ok", "digitization — ≥50 episodes × ≥20 steps"),
        ("paper_step_series_finite", "digitization — step series finite"),
        ("paper_start_near_paper", "digitization — step 0 start near paper (~160.4)"),
        ("paper_peak_step_timing", "digitization — peak power timing (step 1–3)"),
        ("paper_peak_power_near_paper", "digitization — peak power near paper (~278.4)"),
        ("paper_early_mean_near_paper", "digitization — early mean near paper (steps 0–5)"),
        ("paper_mid_mean_near_paper", "digitization — mid mean near paper (steps 6–15)"),
        ("paper_late_mean_near_paper", "digitization — late mean near paper (steps 18–25)"),
        ("paper_overall_mean_near_paper", "digitization — overall mean near paper (~174.0)"),
        ("paper_peak_to_late_drop", "digitization — peak to late drop near paper (~125.5)"),
