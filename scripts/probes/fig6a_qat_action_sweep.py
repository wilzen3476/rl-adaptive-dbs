#!/usr/bin/env python3
"""Sweep open-loop burst actions for Fig 6a QAT weak-lock target (45 Hz)."""
...
def main() -> int:
    ...
    parser.add_argument("--actions", type=str, default="1-6,13-16,22-35")
    ...
    print(f"target={args.target:.1f} band=[{band_lo:.0f},{band_hi:.0f}]", flush=True)
