    ...
    *,
    ...
    if variant == "baseline":
        return replace(
            ...
            actor_mid_episode_stim_logit_boost=0.76,
            actor_midlate_episode_lo=80,
            actor_midlate_episode_hi=150,
            actor_midlate_episode_stim_logit_boost=0.65,
