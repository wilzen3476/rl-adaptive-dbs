...
**Gates set** (`fig1b_gates` → manifest `gates` / `gates_pass`)

| Key | Blocks `gates_pass` |
|-----|---------------------|
...
| `pearson_r` (metrics only; PSD shape diagnostic) | no |
...
**Gates set** (`fig2_time_gates`, panel `2a`)
...
**Gates set** (`fig2_time_gates`, panel `2b`)
...
**Gates set** (`fig4a_gates` → manifest `summary.gates`)
...
**Gates set** (`fig4b_gates` + legacy `_fig4b_pass` → manifest `summary.gates`)
...
**Gates set** (`fig5b_pass` / `fig5_efficacy_gates`)
...
**Gates set** (`_gate_summary` → manifest `gates`)
...
| `ptq-fp16_tracks_fp32` — PTQ fp16 post mean within 15% of fp32 | yes |
| `ptq-int8_tracks_fp32` — PTQ int8 post mean within 15% of fp32 | yes |
...
| `paper_qat_elevated_vs_fp32` | yes |
| `paper_fp32_level_ratio_near_paper` | yes |
| `paper_ptq_int8_level_ratio_near_paper` | yes |
| `paper_ptq_fp16_level_ratio_near_paper` | yes |
| `paper_qat_level_ratio_near_paper` | yes (v40 fails; advisory when qualitative match holds) |
| `paper_ptq_fp16_near_fp32` | yes |
| `paper_ptq_int8_near_fp32` | yes |
| `paper_not_open_loop_override` | yes |
| `paper_not_shared_constant_action_lock` | yes |
...
| `paper_ptq_int8_level_ratio_near_paper` | yes |
| `paper_ptq_fp16_level_ratio_near_paper` | yes |
| `paper_qat_level_ratio_near_paper` | yes |
| `paper_ptq_fp16_near_fp32` | yes |
| `paper_ptq_int8_near_fp32` | yes |
| `paper_not_open_loop_override` | yes |
