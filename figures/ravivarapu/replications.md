...
|-------|-------------|--------|
| Fig 4a | Training PSD vs episode | Fail (`dig_gap_widens_mid_to_late` (shape), v34) |
...
![Replication Fig 4a](images/4a/training_psd_v34.png)

<!-- caption-4a:start -->
**Caption:** Training mean GPi beta PSD vs episode (seed 0); shape_pass=False pass=False; Baseline vs full SEA-DBS (PM+GS). (v34)
