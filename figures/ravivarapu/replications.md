...
|-------|-------------|--------|
| Fig 4a | Training PSD vs episode | Fail (`dig_early_mid_to_mid_drop_sea_not_front_loaded` (shape), v11) |
...
![Replication Fig 4a](images/4a/training_psd_v11.png)

<!-- caption-4a:start -->
**Caption:** Training mean GPi beta PSD vs episode (seed 0); shape_pass=False pass=False; Baseline vs full SEA-DBS (PM+GS). (v11)
