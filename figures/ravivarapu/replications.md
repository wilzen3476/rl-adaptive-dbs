...
|-------|-------------|--------|
| Fig 4a | Training PSD vs episode | Fail (`dig_progressive_decline_baseline` (shape), v16) |
...
![Replication Fig 4a](images/4a/training_psd_v16.png)

<!-- caption-4a:start -->
**Caption:** Training mean GPi beta PSD vs episode (seed 0); shape_pass=False pass=False; Baseline vs full SEA-DBS (PM+GS). (v16)
