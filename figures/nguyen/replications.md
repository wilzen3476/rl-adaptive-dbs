...
![Replication Fig 4 — latest](images/4/training_reward_length_v92.png)
...
**Caption:** DSQN train 500 ep, seed=0; late_reward=-13106, late_len=8.5; shape_pass=False pass=False (reward shape=True full=False, length shape=False full=False) (v92)

**Manifest:** `artifacts/figures/papers/nguyen/4/manifest.json`
<!-- caption-4-latest:end -->

**Status:** Timing shape open — latest **v92** (`late_len=8.5`, `shape_pass=False`); see manifest gates.
