...
![Replication Fig 4 — latest](images/4/training_reward_length_v103.png)
...
**Caption:** DSQN train 500 ep, seed=0; late_reward=-4420, late_len=7.0; shape_pass=True pass=False (reward shape=True full=False, length shape=True full=True) (v103)

**Manifest:** `artifacts/figures/papers/nguyen/4/manifest.json`
<!-- caption-4-latest:end -->

**Status:** Timing shape open — latest **v103** (`late_len=7.0`, `shape_pass=True`); see manifest gates.
