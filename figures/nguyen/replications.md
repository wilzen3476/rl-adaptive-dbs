...
![Replication Fig 5](images/5/spikes_energy_v33.png)

<!-- caption-5:start -->
**Caption:** Fig 4 shared train 500 ep, seed=0; spike_mean=833, energy_mean=1724.4; pass=False (v33)

**Manifest:** `artifacts/figures/papers/nguyen/5/manifest.json`
<!-- caption-5:end -->

**Status:** Open — see manifest gates (`spikes_energy_v33.png`).
