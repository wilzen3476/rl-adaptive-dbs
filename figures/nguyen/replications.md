...
![Replication Fig 4 — latest](images/4/training_reward_length_v106.png)
...
**Caption:** DSQN train 500 ep, seed=0; late_reward=-12622, late_len=7.7; shape_pass=False pass=False (reward shape=False full=False, length shape=False full=False) (v106)

**Manifest:** `artifacts/figures/papers/nguyen/4/manifest.json`
<!-- caption-4-latest:end -->

**Status:** Timing shape open — latest **v106** (`late_len=7.7`, `shape_pass=False`); see manifest gates.
...
![Replication Fig 5](images/5/spikes_energy_v9.png)

<!-- caption-5:start -->
**Caption:** Fig 4 shared train 500 ep, seed=0; spike_mean=432, energy_mean=465.3; pass=False (v9)

**Manifest:** `artifacts/figures/papers/nguyen/5/manifest.json`
<!-- caption-5:end -->

**Status:** Open — see manifest gates (`spikes_energy_v9.png`).
...
| `paper_spike_early_near_paper` | digitization — spike early ep 0–50 | yes |
