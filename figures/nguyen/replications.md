...
![Replication Fig 4 — latest](images/4/training_reward_length_v87.png)
...
**Caption:** DSQN train 500 ep, seed=0; late_reward=-35710, late_len=10.1; shape_pass=True pass=False (reward shape=True full=False, length shape=True full=False) (v87)

**Manifest:** `artifacts/figures/papers/nguyen/4/manifest.json`
<!-- caption-4-latest:end -->

**Status:** Timing shape open — latest **v87** (`late_len=10.1`, `shape_pass=True`); see manifest gates.
