...
![Replication Fig 4 — latest](images/4/training_reward_length_v116.png)
...
**Caption:** DSQN train 500 ep, seed=0; late_reward=-8066, late_len=8.8; shape_pass=True pass=False (reward shape=True full=True, length shape=True full=False) (v116)

**Manifest:** `artifacts/figures/papers/nguyen/4/manifest.json`
<!-- caption-4-latest:end -->

**Status:** Timing shape open — **v116** reward full pass, length ptp **4.80** (post100 only); **v117** fresh `pw_min=0.45` in flight (`nguyen-fig4-v117`).
...
![Replication Fig 5](images/5/spikes_energy_v17.png)

<!-- caption-5:start -->
**Caption:** Fig 4 shared train 500 ep, seed=0; spike_mean=606, energy_mean=524.6; pass=False (v17)

**Manifest:** `artifacts/figures/papers/nguyen/5/manifest.json`
<!-- caption-5:end -->

**Status:** Open — see manifest gates (`spikes_energy_v17.png`).
