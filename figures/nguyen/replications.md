...
| Fig 4 | Training reward + episode length | Pass (rep v98) |
...
<!-- gates-3:start -->
**Gates set** (`artifacts/figures/papers/nguyen/3/manifest.json`; overall **`pass`**: yes, 2026-08-21). Every row is required for exit.
...
![Replication Fig 4 — latest](images/4/training_reward_length_v98.png)
...
**Caption:** DSQN train 5 ep, seed=0; late_reward=-245426, late_len=8.0; shape_pass=True pass=True (reward shape=True full=True, length shape=True full=True) (v98)

**Manifest:** `artifacts/figures/papers/nguyen/4/manifest.json`
<!-- caption-4-latest:end -->

**Status:** Pass — see manifest gates (`training_reward_length_v98.png`).

<!-- gates-4:start -->
**Gates set** (`artifacts/figures/papers/nguyen/4/manifest.json`; **`shape_pass`**: yes, **`pass`**: yes, 2026-08-21). Phase 1: **`shape_pass`** (curve shape). Ship exit: **`pass`** (adds digitization polish). Both subplot groups required.
...
<!-- caption-5:start -->
**Caption:** Fig 4 shared train 500 ep, seed=0; spike_mean=1014, energy_mean=557.6; pass=False (v8)
...
<!-- gates-6:start -->
**Gates set** (`artifacts/figures/papers/nguyen/6/manifest.json`; overall **`pass`**: no, 2026-08-21). Every row is required for exit.
...
<!-- gates-7:start -->
**Gates set** (`artifacts/figures/papers/nguyen/7/manifest.json`; overall **`pass`**: no, 2026-08-21). Every row is required for exit.
